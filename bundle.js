...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.changePassword(data).then(ui.success).catch(ui.changePasswordSuccess);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var logic = __webpack_require__(11);
	var game_events = __webpack_require__(13);
	...
	var player_turn = function player_turn() {
	  if (player_switch === 'x') {
	    player_switch = 'y';
	  } else {
	    player_switch = 'x';
	...
	var check_game = function check_game() {
	  $.each($('.content'), function (index, value) {
	    var new_text = $(value).text();
	    var i = index;
	    board.splice(i, 1, new_text);
	  });
	};

	var change_box = function change_box() {
	  $('.game-data').text('');
	  if ($(this).text() === '') {
	    ...
	    value = $(this).text();
	    check_game();
	    var over = logic.check_win(board);
	...
	var game_reset = function game_reset() {
	  player_switch = 'x';
	  board = ['', '', '', '', '', '', '', '', ''];
	  $('.content').text('');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clickhandlers = __webpack_require__(10);
	var reset = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var game_ui = __webpack_require__(14);
	var game_api = __webpack_require__(15);
	var clicks = __webpack_require__(10);

	var onGetIndex = function onGetIndex(e) {
	  e.preventDefault();
	  game_api.getIndex().then(game_ui.index_success).catch(game_ui.failure);
	};

	var onCreateGame = function onCreateGame(e) {
	  e.preventDefault();
	  game_api.createGame().then(game_ui.create_success).catch(game_ui.failure);
	};

	var onShowGame = function onShowGame(e) {
	  e.preventDefault();
	  game_api.showGame().then(game_ui.data_success).catch(game_ui.failure);
	};

	var onUpdateGame = function onUpdateGame(index, value, over) {
	  game_api.updateGame(index, value, over).then(game_ui.success).catch(game_ui.failure);
	};
	module.exports = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var index_success = function index_success(data) {
	  $('.game-data').text('You have played ' + data.games.length + ' games!');
	};

	var create_success = function create_success(data) {
